...
os.system('ffmpeg -y -i ' + sys.argv[1] + ' -r 5 -an -crf 28 -vf "crop=1448:130:327:832" 2.' + sys.argv[1])
os.system('ffmpeg -y -i 2.' + sys.argv[1] + ' -vf mpdecimate,setpts=N/FRAME_RATE/TB 3.' + sys.argv[1])
